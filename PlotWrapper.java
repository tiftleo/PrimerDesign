...
public class PlotWrapper {
    ...
    public static void plot(String inputFile, String outputFile) throws IOException {

        String figWidth = Integer.toString(20);
        String figHeight = Integer.toString(10);
        String figDPI = Integer.toString(135);

        ProcessBuilder pb = new ProcessBuilder("python", sourse, inputFile, outputFile, figWidth, figHeight, figDPI);
        Process p = pb.start();
