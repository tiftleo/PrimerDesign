...
public class Primer3Wrapper {
    private double _mv = 50.0; // Conc of monovalent cations
    private double _dv = 1.5; //  Conc of divalent cations
    ...
    public Primer3Wrapper(String os)  {
    ...
    private static native void initThermoPath();
