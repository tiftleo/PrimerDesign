...
public class ScreenUserInput {
    ...
    public ScreenUserInput(CommandLine commandLine) throws IOException {
        ...
        if (commandLine.hasOption("tempMin")) {
            ...
            this.tempMin = Integer.parseInt(commandLine.getOptionValue("tempMin"));
        ...
        if (commandLine.hasOption("tempMax")) {
            ...
            this.tempMax = Integer.parseInt(commandLine.getOptionValue("tempMax"));
        ...
        if (commandLine.hasOption("hairMax")) {
            ...
            this.hairMax = Integer.parseInt(commandLine.getOptionValue("hairMax"));
        ...
        if (commandLine.hasOption("homoMax")) {
            ...
            this.homoMax = Integer.parseInt(commandLine.getOptionValue("homoMax"));
